...
If you're an RPI student, hop in on our first meeting of the semester or join [our mattermost](https://chat.rcos.io) and message a faculty coordinator (@turnew2).

If you're looking to get involved with RCOS as a member outside of RPI, email a [coordinator](mailto:coordinators-active@rcos.io) to get setup on the [rcos mattermost](#mattermost). In the meantime, you can create an account and fill in your profile on [Observatory](#observatory).
...
[Mattermost](https://chat.rcos.io) is the primary communication platform for RCOS. Each team in RCOS has a Mattermost channel where they can coordinate meetings and manage the project. Here's a [intro](https://github.com/Apexal/late/wiki/How-Git-Works) written by one of our coordinators.
